(() => {
  ...
  const messages = {
    en: {
      ...
      vehicleLegend: "Speed: red < 3 m/s · gold 3–<8 m/s · blue ≥ 8 m/s · Car size is illustrative. Motion between 8-second samples is approximate; zoom in for detail.",
    ...
    fr: {
      ...
      vehicleLegend: "Vitesse : rouge < 3 m/s · or 3–<8 m/s · bleu ≥ 8 m/s · Taille des voitures illustrative. Mouvement approximatif entre les échantillons espacés de 8 secondes ; zoomez pour voir les détails.",
    ...
    ar: {
      ...
      vehicleLegend: "السرعة: أحمر: \u2066< 3 m/s\u2069 · ذهبي: \u20663–<8 m/s\u2069 · أزرق: \u2066≥ 8 m/s\u2069 · أحجام السيارات توضيحية. الحركة بين العينات كل 8 ثوانٍ تقريبية؛ كبّر الخريطة لرؤية التفاصيل.",
